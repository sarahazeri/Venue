                        ...
                        <div class="card">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <!-- Button Tambah -->
                                    <button type="button" class="tambah btn btn-primary" data-toggle="modal" id="tambah"
...
@section('ajax')
    <script>
        ...
        $('#tambah').on('click', function () {
            ...
            $("#modalTambah [name='title']").val('')
            $("#modalTambah [name='address']").val('')
        })
        ...
        function tambah() {
            ...
            $.ajax({
                ...
                error: function (err) {
                    ...
                    $("#modalTambah [name='title']").addClass("is-invalid")
                    $("#modalTambah [name='address']").addClass("is-invalid")
                }
            })
        }
        ...
        $(document).on('click', '.update', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $("#modalTambah [name='title']").val(res.data.title)
                    $("#modalTambah [name='address']").val(res.data.address)
                    $("#modalTambah [name='address']").removeClass("is-invalid")
                    $("#modalTambah [name='address']").removeClass("is-invalid")
                }
            })
        })
